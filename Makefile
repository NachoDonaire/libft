SRCS    =   ft_isascii.c  ft_bzero.c ft_isalpha.c ft_isalnum.c \
            ft_isdigit.c ft_isprint.c ft_memcpy.c ft_memmove.c \
            ft_memset.c ft_strchr.c ft_strlcpy.c ft_strlen.c ft_toupper.c \
            ft_tolower.c ft_memchr.c ft_memcmp.c ft_strrchr.c ft_strlcat.c \
